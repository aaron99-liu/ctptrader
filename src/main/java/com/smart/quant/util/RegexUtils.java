...
public class RegexUtils {
     ...
     * <p>
     * 联通的号段：130、131、132、155、156（世界风专用）、185（未启用）、186（3g）</p>
     * <p>
     * 电信的号段：133、153、180（未启用）、189</p>
     * @return 验证成功返回true，验证失败返回false
     */
     ...
     * <p>
     * <b>电话号码：</b>这包含从 0 到 9 的一个或多个数字 </p>
     * @return 验证成功返回true，验证失败返回false
     */
    ...
    public static boolean checkCtpUri(String uri) {
    	String regex = "^tcp://[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]";
