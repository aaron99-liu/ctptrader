...
public class BankTransferReq {
	...
	Integer plateSerial;	///银期平台消息流水号
	String lastFragment;	///最后分片标志
	Integer sessionID;	///会话号
	...
	Integer installID;	///安装编号
	Integer futureSerial;	///期货公司流水号
	String userID;	///用户标识
	String verifyCertNoFlag;	///验证客户证件号码标志
	String currencyID;	///币种代码
	BigDecimal tradeAmount;	///转帐金额
	BigDecimal futureFetchAmount;	///期货可取金额
	String feePayFlag;	///费用支付标志
	BigDecimal custFee;	///应收客户费用
	BigDecimal brokerFee;	///应收期货公司费用
	String message;	///发送方给接收方的消息
	String digest;	///摘要
	...
	public BigDecimal getFutureFetchAmount() {
		return futureFetchAmount;
	}
	public void setFutureFetchAmount(BigDecimal futureFetchAmount) {
